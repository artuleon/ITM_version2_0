...
//-----------------------
// Control property codes
//-----------------------
  CTRL_INIT_SETTING_INDEX   = 1;
  CTRL_CLOSE_RATE_INDEX     = 2;
  CTRL_TIME_SERIES_INDEX    = 3;
  CTRL_CONTROL_NODE_INDEX   = 4;
  CTRL_CONTROL_CURVE_INDEX  = 5;
