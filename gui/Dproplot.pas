...
procedure TProfilePlotOptionsForm.ColorBox3GetColors(Sender: TCustomColorBox;
  Items: TStrings);
begin
  with sender as TColorBox do
  begin
    Items.AddObject('Light Gray', TObject(clWeblightgrey));
    Items.AddObject('Smoke',TObject(clWebWhiteSmoke));
    Items.AddObject('Snow',TObject(clWebSnow));
  end;
end;
