...
begin
  ...
  if Project.IsNode(FlyoverObject) then HintPanel.Color := clAqua
...
begin
  ...
  begin
    ...
    if SelectedObject = MAPLABEL then
    begin
...
//-----------------------------------------------------------------------------
begin
  if Project.IsLink(HiliteObject) then
  begin
...
//    SelectedObject   (e.g., junction, conduit, etc.)
...
begin
  ...
  MainForm.MapButton2.Enabled := (SelectedLink <> nil);
  HiliteOff;
  HiliteOn;
end;
...
begin
  ...
  if (Project.IsNode(HiliteObject)) and (Map.Options.ShowNodes) then
  begin
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        Visible := False;
        if (J <= WEIR) and (J <> CurrentList) then
        begin
          Caption := ObjectLabels[J];
          Visible := True;
        end;
...
begin
  ...
  CONDUIT:       Uclipbrd.CopyLink(CurrentList, I);
...
begin
  ...
  CONDUIT:       Uclipbrd.PasteLink(CurrentList, I);
