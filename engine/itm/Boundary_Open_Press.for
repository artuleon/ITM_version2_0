...
! 02110-1301, USA.
	...
	If(BCnode(R)==7.or.BCnode(R)==20.or.BCnode(R)==4)then !Junction/Reserv/Dropsh	
	      ...
	      !Also we have to check if the junction is ventilated. If it is ventilated, we could use 
	      !Yser_jun_old(R) as a way of checking depressurization. Otherwise this can not be used.
	      ...
	      do i = 1, NodeNS(R) 
	          ...
	          Elseif (Nodetype(R,i) == 1)then !inflowing
	              ...
	              write(98,*),'Boundary_Open_Press. Nodetype UNKNOWN'
                    write(99,*),'Boundary_Open_Press. Nodetype UNKNOWN'
...
5         do i = 1, NodeNS(R)      
   ...
   18     do i = 1, NodeNS(R) 
      ...
      !Gate with one single pipe (always ventilated)
	    ...
	    write(98,*),'Subr.Boundary_Open_Press. BC not supported'
          write(99,*),'Subr.Boundary_Open_Press. BC not supported'
		call endprog; GLOBAL_STATUS_FLAG = 1; return
      endif
      end subroutine