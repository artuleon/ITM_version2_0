...
! 02110-1301, USA.
	...
	return
      ...
      !########################################
	!Rarefaction wave approximation
	function Rarefact_Phi(phiL,phiR,uL,uR)
      implicit none
	double precision phiL,phiR,uL,uR      
	double precision Rarefact_Phi
	Rarefact_Phi = ((phiL + phiR) + (uL-uR))/2d0 
	return
	end function